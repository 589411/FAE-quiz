const questions = [
    {
        question: "在太空站遇到緊急情況時，你會優先？",
        options: [
            { text: "立即組織人員撤離，確保安全", scores: { "指揮官": 2, "戰鬥指揮官": 1 } },
            { text: "檢查受損情況，進行必要維修", scores: { "科學家": 2, "醫療專家": 1 } },
            { text: "確保通訊系統正常，聯繫支援", scores: { "星際通訊官": 2, "指揮官": 1 } }
        ]
    },
    {
        question: "當發現一個未知的太空文明遺跡，你的第一反應是？",
        options: [
            { text: "仔細掃描和分析遺跡的科技", scores: { "科學家": 2, "星際通訊官": 1 } },
            { text: "評估潛在威脅，部署防禦措施", scores: { "戰鬥指揮官": 2, "指揮官": 1 } },
            { text: "尋找可能的通訊或文字記錄", scores: { "星際通訊官": 2, "科學家": 1 } },
            { text: "建立安全區域，保護探索隊伍", scores: { "醫療專家": 2, "指揮官": 1 } }
        ]
    },
    {
        question: "在一次深空探索任務中，你最想負責的工作是？",
        options: [
            { text: "制定探索路線和資源分配", scores: { "指揮官": 2, "科學家": 1 } },
            { text: "操作探測設備收集數據", scores: { "科學家": 2, "醫療專家": 1 } },
            { text: "維護船員身心健康", scores: { "醫療專家": 2, "星際通訊官": 1 } },
            { text: "負責與母星保持聯繫", scores: { "星際通訊官": 2, "指揮官": 1 } }
        ]
    },
    {
        question: "面對外星生物襲擊時，你會？",
        options: [
            { text: "指揮部隊展開反擊", scores: { "戰鬥指揮官": 2, "指揮官": 1 } },
            { text: "分析其弱點尋找對策", scores: { "科學家": 2, "戰鬥指揮官": 1 } },
            { text: "嘗試建立溝通管道", scores: { "星際通訊官": 2, "醫療專家": 1 } }
        ]
    },
    {
        question: "在太空船資源短缺時，你會？",
        options: [
            { text: "重新分配資源，優化使用", scores: { "指揮官": 2, "醫療專家": 1 } },
            { text: "研究替代方案和解決方法", scores: { "科學家": 2, "指揮官": 1 } },
            { text: "尋求附近星球或太空站支援", scores: { "星際通訊官": 2, "戰鬥指揮官": 1 } }
        ]
    },
    {
